...
use easybill\eInvoicing\Specs\ZUGFeRD\Models\Indicator;
...
use easybill\eInvoicing\Specs\ZUGFeRD\Models\TradeAllowanceCharge;
...
test(
    'building ZUGFeRD cii document for BASIC_Einfach.xml',
    function () {
        $invoice = DocumentFactory::createZUGFeRDInvoice(ZUGFeRDProfileType::BASIC);
        ...
        $this->buildAndAssertXmlFromCII(
            ...
            SchemaValidator::SCHEMA_BASIC
        );
    }
);

test(
    'building ZUGFeRD CII document for BASIC_Rechnungskorrektur.xml',
    function () {
        $invoice = DocumentFactory::createZUGFeRDInvoice(ZUGFeRDProfileType::BASIC);
...
test(
    'building ZUGFeRD CII document for BASIC_Taxifahrt.xml',
    function () {
        $invoice = DocumentFactory::createZUGFeRDInvoice(ZUGFeRDProfileType::BASIC);
